...
const userTarotFirstpage = () => {
    return (
        <div className="bg-primary-variant w-full min-h-screen">
            <div className="p-6 flex flex-col items-center lg:py-10 lg:w-80 lg:mx-auto lg:px-0">
                <img className="w-80 h-[428px] rounded-2xl"
                    src={catImage}
                />
                <div className="flex flex-col items-center my-6 lg:my-8">
                    <div className="text-primary text-5xl font-bold py-3
                    lg:text-4xl lg:py-2">เกมทายนิสัย</div>
                    <div className="text-white text-base font-bold
                    lg:text-xl lg:py-1">มาหาสัตว์เลี้ยงที่เหมาะกับคุณกัน!</div>
                </div>
