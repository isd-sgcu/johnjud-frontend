...
const FAQ = () => {
    ...
    return <>
        <div className="relative  text-teal-600 pb-16 px-10 mt-9">
            <div className="flex flex-col items-center mb-6">
                ...
                <div className="relative flex w-full bg-gray-100 rounded-full p-3 shadow">
                    <img src="../../public/bubble.svg" alt="_blank" />
                    <input type="text" placeholder="ค้นหาคำถาม" className="bg-transparent rounded-md text-black ml-3 w-full" />{" "}
                </div>
            </div>
