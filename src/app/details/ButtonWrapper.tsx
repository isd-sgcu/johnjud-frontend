    ...
    <div className="flex flex-col gap-2.5 font-semibold text-white xl:justify-between">
      <div className="justify-between xl:flex">
        <div className="flex gap-4 xl:flex-col xl:items-start xl:gap-4">
          <div className="flex items-center justify-center gap-2 rounded-full bg-secondary px-3 py-1 shadow-[0_0_2px_1px] shadow-zinc-300">
            <Icon icon="ph:eyedropper-bold" color="white" className="h-4 w-4" />
            <span>ฉีดวัคซีนแล้ว</span>
          </div>
          <div className="justify-centerpy-1 flex items-center gap-2 rounded-full bg-secondary px-3 py-1 shadow-[0_0_2px_1px] shadow-zinc-300">
      ...
      {isAdmin ? (
        <div className="flex justify-between xl:gap-8">
          ...
          <button className="flex items-center gap-2 rounded-2xl bg-secondary px-6 py-2 text-lg font-normal shadow-[0_0_2px_1px] shadow-zinc-300">
