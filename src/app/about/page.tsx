...
const About = () => {
    return (
        <div className="flex flex-col items-center justify-center">
            <div className="mt-[28px] text-[20px] text-center">
                เกี่ยวกับ
            </div>
            <div className="font-bold text-[40px] text-primary text-center">
                ชมรมสวัสดิภาพสัตว์
            </div>
            <img src="johnjud-with-text.png" className="w-[55%]" />
            <div className="font-bold text-[40px] underline text-primary text-center">
                พวกเราเป็นใคร
            </div>
            <p className="mt-[5px] mx-[8%] bg-white rounded-[20px] shadow-lg py-[12px] px-[24px] text-[20px] text-center">
            ...
            <div className="flex flex-col items-center my-[24px] relative ">
