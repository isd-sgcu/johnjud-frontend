      ...
      <div className={filterContainer()}>
        ...
        <FilterPanel heading="สี">
          ...
          <ToggleInput
            id="color-tabby"
            text="สลิด"
            checked={filters.tabby}
            onChange={handleToggleChange("tabby")}
          />
          <ToggleInput
            id="color-white-black"
            text="ขาวดำ"
            checked={filters.whiteBlack}
            onChange={handleToggleChange("whiteBlack")}
          />
          <ToggleInput
            id="color-white-orange"
            text="ขาวส้ม"
            checked={filters.whiteOrange}
            onChange={handleToggleChange("whiteOrange")}
          />
          <ToggleInput
            id="color-tortoise-shell"
            text="เปรอะ"
            checked={filters.tortoiseShell}
            onChange={handleToggleChange("tortoiseShell")}
          />
          <ToggleInput
            id="color-calico"
            text="สามสี"
            checked={filters.calico}
            onChange={handleToggleChange("calico")}
          />
          <ToggleInput
            id="color-gray"
            text="เทา"
            checked={filters.gray}
            onChange={handleToggleChange("gray")}
          />
          <ToggleInput
            id="color-cream"
            text="ครีม"
            checked={filters.cream}
            onChange={handleToggleChange("cream")}
          />
          <ToggleInput
            id="color-brown-spots"
            text="แต้มน้ำตาล"
            checked={filters.brownSpots}
            textSize="text-sm"
            onChange={handleToggleChange("brownSpots")}
          />
          <ToggleInput
            id="color-gray-spots"
            text="แต้มเทา"
            checked={filters.greySpots}
            onChange={handleToggleChange("greySpots")}
          />
          <ToggleInput
            id="color-orange-spots"
            text="แต้มส้ม"
            checked={filters.orangeSpots}
            onChange={handleToggleChange("orangeSpots")}
          />
          <ToggleInput
            id="color-dirty-spots"
            text="แต้มเปรอะ"
            checked={filters.dirtySpots}
            textSize="text-sm"
            onChange={handleToggleChange("dirtySpots")}
          />
        </FilterPanel>
