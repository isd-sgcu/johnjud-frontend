...
const SideBar: React.FC<SideBarProps> = ({ color }) => {
  return (
    <div
      className={`h-full p-6 py-8  text-sm text-white ${color} w-[180px] xl:w-64 xl:pl-10 xl:pr-16 xl:pt-10`}
    >
      <div className="mb-6 flex cursor-pointer items-center gap-4 border-b border-white pb-6">
