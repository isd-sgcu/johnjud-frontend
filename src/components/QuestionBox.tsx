...
const questionBox = ({question, answer}: { question: string, answer: string }) => {
    ...
    <div className="bg-white rounded-3xl flex flex-col shadow-lg mb-6">
        ...
        >
            ...
            <img className={"w-4 h-2 transition-all duration-300 " + (showed ? "rotate-180" : "")} src="../../public/back_icon.svg" alt="_blank" />
        </div>
        <div className={"transition-all duration-300 " + (showed ? "block" : "hidden")}>      
