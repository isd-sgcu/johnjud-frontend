...
export const forgetPasswordMutationOption: UseMutationOptions<ForgetPasswordResponse, Error, ForgetPasswordCredentials> = {
    ...
    onError: (error: Error) => {
        ...
        setError(error instanceof Error ? error : new Error("Forget password failed"));
    },
    onSettled: () => {
